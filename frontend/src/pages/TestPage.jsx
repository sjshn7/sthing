...
export default function TestPage() {
  ...
  function handleNext() {
    ...
    const newAnswers = [...answers, { id: question.id, value: selected.value, idx: selected.idx }]
  ...
  function handlePrev() {
    ...
    setSelected({ idx: prevAnswer.idx, value: prevAnswer.value })
    setCurrent(current - 1)
  }

  return (
    <div className="min-h-screen bg-[#080808] flex flex-col items-center relative overflow-x-clip py-4">
      ...
      {/* 콘텐츠 */}
      <div className="relative z-10 w-full max-w-[350px] flex flex-col px-8 pt-4 flex-1 gap-3">
